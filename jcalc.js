...
// Table //////////////////////////////////////////////////////////////
  ...
  Table.prototype.edit = function(options) {
    ...
    this._code = jc.output._codeElement;   
    $(this._code).addClass('AUTOEDIT').attr('jcObject',this._name);
  ...
  Table.prototype.editorEvent = function(event){
    ...
    switch (event.type) {
      case 'click':
        if (this._code !== jc.selectedElement) {
          jc.selectElement(this._code);
        }
      ...
      case 'change':
        ...
        this._code.innerHTML = jc.toHtml(this.generateCode());
        jc.setModified(true);
  ...
  Table.force = function(type) {
    var cell$ = $(jc.vars[jc.selectedElement.jcObject]._editedCell).removeClass('STRING NUMBER FUNCTION UNDEFINED').addClass(type);
...
/*
  Table.prototype.cellFormat = function(cell) {
    return cell.className.match(/NUMBER|STRING|FUNCTION|UNDEFINED/)
  }                  
*/
