...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  // if name === undefined nothing is done
    ...
    let node = this.graph.node(type,name);
    this.linkNode(node);
    return this;
  };
  ...
  // a node (type,category) is created for each category
    ...
    delimiter = delimiter || / +/;
    let catArray = categories.split(delimiter);
    for (let i = 0;i<catArray.length;i++) {
      let c = this.graph.node(type,catArray[i]);
      this.linkNode(c);
      c.linkWith('_',type);
    }
    return this;
